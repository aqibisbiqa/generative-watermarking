...
class StegoStableVideoDiffusionPipeline(DiffusionPipeline):
    r"""
    ...
    def __call__(
        ...
        Returns:
            [`~pipelines.stable_diffusion.StegoStableVideoDiffusionPipelineOutput`] or `tuple`:
                If `return_dict` is `True`, [`~pipelines.stable_diffusion.StegoStableVideoDiffusionPipelineOutput`] is
            ...
            for i, t in enumerate(timesteps):
                ...
                if i not in [self.num_timesteps-2]:
                    ...
                    if stego_type == "encode":
                        ...
                        print("boutta mix")
                        err_rate = 1 - empirical_success_rates["video"]    # used for error correction
