...
# from .pipeline_output import StegoStableDiffusionPipelineOutput
...
class StegoStableDiffusionPipeline(StableDiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        extra_step_kwargs_0 = self.prepare_extra_step_kwargs(g_k_0, eta)
        extra_step_kwargs_1 = self.prepare_extra_step_kwargs(g_k_1, eta)
            ...
            for i, t in enumerate(timesteps):
                ...
                if i not in [self.num_timesteps-2]:
                    ...
                    if stego_type == "encode":
                        ...
                        print(f"latents {latents.shape}, prompt_embeds {prompt_embeds.shape}")
